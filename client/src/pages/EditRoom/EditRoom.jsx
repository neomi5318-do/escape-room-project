...
//     // סטייט התחלתי מסודר של נתוני הטופס
...
//             try {
//                 const serverData = await getRoomById(roomId);
//                 // בדיקת הגנה בטוחה על הנתונים שחוזרים מהשרת
//                 if (serverData && serverData.room) {
//                     setFormData({
//                         title: serverData.room.title || '',
//                         description: serverData.room.description || '',
//                         timer_minutes: (serverData.room.timer_seconds || 900) / 60,
//                         difficulty_level: serverData.room.difficulty_level || 1,
//                         min_points_required: serverData.room.min_points_required || 0,
//                         bg_image_id: serverData.room.bg_image_id || 1,
//                         bg_audio_id: serverData.room.bg_audio_id || '' 
//                     });
//                 }
//             } catch (err) {
...
//     // פונקציית עדכון השדות בטופס בלייב
//     const handleChange = (e) => {
//         setFormData({ ...formData, [e.target.name]: e.target.value });
//     };

//     // פונקציית שליחת הטופס המעודכן לשרת לביצוע ה-Update ב-MySQL
...
//             // שינוי שם המשתנה ל-resData כדי למנוע שגיאות ReferenceError מחוץ לבלוק
//             const resData = await updateRoom(roomId, roomDataForServer);

//             if (resData && resData.success) {
//                 setSuccessModal({ show: true });
//             } else {
//                 setError(resData?.message || 'שגיאה בעדכון החדר.');
//             }
//         } catch (err) {
