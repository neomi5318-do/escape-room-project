...
const createQuestion = async (req, res) => {
    ...
    const { question_text, correct_answer, hint_text } = req.body;
    ...
    try {
        const questionId = await QuestionModel.create(roomId, question_text, correct_answer, hint_text || '');
...
const updateQuestion = async (req, res) => {
    ...
    try {
        // בדיקה שהשאלה בכלל קיימת בבסיס הנתונים
        ...
        await QuestionModel.update(id, question_text, correct_answer, hint_text || '');
...
const deleteQuestion = async (req, res) => {
    ...
    try {
        // בדיקה שהשאלה קיימת לפני שמוחקים
        // const existingQuestion = await QuestionModel.findById(id);
        // if (!existingQuestion) {
